...
let FETCH_GLOBAL_KINDS_WITH_REPLIES: Set<Int> = [1,1222,1244,5,6,20,9802,30023,34235]
...
let FETCH_FOLLOWING_FEED_KINDS_WITH_REPLIES: Set<Int> = [1,1222,1244,5,6,20,9802,30023,34235,30311]
...
let QUERY_FOLLOWING_KINDS_WITH_REPLIES: Set<Int> = [1,1222,1244,6,20,9802,30023,34235]
