    ...
    struct MediaUploadProgressPreview: View {
        ...
        var body: some View {
            ...
            .onAppear {
                ...
                let exampleCompleted = MediaRequestBag(apiUrl: URL(string: "http://localhost")!, mediaData: Data())
                ...
                let exampleProgress = MediaRequestBag(apiUrl: URL(string: "http://localhost")!, mediaData: Data())
