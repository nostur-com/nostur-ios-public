...
#Preview {
    struct MediaUploadProgressPreview: View {
        @State var uploader = Nip96Uploader() // @TODO: Make progress independent of Uploader type (NIP96 / Blossom)
        @State var percentage:Int = 15
        var body: some View {
            VStack {
                MediaUploadProgress(uploader: uploader) // @TODO: Make progress independent of Uploader type (NIP96 / Blossom)
            ...
            .onAppear {
                ...
                let exampleCompleted = MediaRequestBag(apiUrl: URL(string: "http://localhost")!, mediaData: Data(), authorizationHeader: "", boundary: "")
                ...
                let exampleProgress = MediaRequestBag(apiUrl: URL(string: "http://localhost")!, mediaData: Data(), authorizationHeader: "", boundary: "")
